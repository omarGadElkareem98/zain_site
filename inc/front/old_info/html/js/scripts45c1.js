...
jQuery(function ($) {
    ...
    $(document).ready(function(){
        $(".player").YTPlayer();
        //$('<style>.whatsapp_content {position: fixed;bottom: 30px;left: 20px;cursor: pointer;z-index: 99999999;} .whatsapp_content a.whatsapp_link {font-size: 28px;color: rgb(255, 255, 255);padding: 12px;background-color: rgb(37, 211, 102);border-radius: 50%;direction: rtl;width:52px;height:52px;line-height: 1; margin: 0;}</style><div class="ht-ctc-chat style-7 desktop whatsapp_content"> <a title="" class="icon icon-whatsapp whatsapp_link" id="s7-icon" target="_blank" onmouseover="this.style.color = \'#455a64\', this.style.backgroundColor = \'#25D366\' " onmouseout="this.style.color = \'#ffffff\', this.style.backgroundColor = \'#25D366\' " href="https://wa.me/00966550473258"><img src="/html/img/whatsapp2.png" style="margin-top: 0;width: 28px;height: 28px;filter: invert(98%) sepia(1%) saturate(1%) hue-rotate(189deg) brightness(200%) contrast(99%);"></a></div>').insertAfter($('footer').children().eq(0));
    });
